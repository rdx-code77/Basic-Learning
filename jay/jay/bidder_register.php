...
<body>
	<div class="bg">
	<?php include('bidder_server.php') ?>
	<?php include('shopowner_server.php') ?>
	<div class="header">
		<h2>Farmer Register</h2>
	</div>
	
	<form method="post" action="bidder_register.php">
		...
		<div class="input-group">
			<label>Bidding cost per Kg</label>
			<input type="number" name="tcost" value="<?php echo $tcost; ?>" required>
		</div>
		<div class="input-group">
			<label>Shop ID</label>
		...
		<div class="input-group">
			<button type="submit" class="btn" name="reg_bidder">Register</button>
		</div>
		<div class="input-group">
