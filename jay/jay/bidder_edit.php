...
{array_push($errors, "both are same"); }
		...
		if (count($errors) == 0) {
			...
			$query=mysqli_query($db,"SELECT phno FROM bidders WHERE  phno='$phn1'");
			
		if (mysqli_num_rows($query) == 1) {
		$query = "UPDATE bidders SET bidders.phno='$phn2' WHERE bidders.phno='$phn1'";
...
?>
	...
	<form method="post" action="bidder_edit.php">
