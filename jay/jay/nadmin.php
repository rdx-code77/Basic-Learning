...
<header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
  ...
  <div class="w3-display-middle w3-margin-top w3-center">
    <h1 class="w3-xxlarge w3-text-white"><span class="w3-padding w3-black w3-opacity-min"><b>Ad</b></span> <span class="w3-hide-small w3-text-light-grey"><?php echo $_SESSION['username'] ?></span></h1>
  </div>
</header>
